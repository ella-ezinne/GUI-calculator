...
def equalpress():
    # Try and expect statement is used for handling errors like zero division error, etc.
...
if __name__ == "__main__":
    ...
    #when user press the button, the command or function affiliated to that button is expected.
